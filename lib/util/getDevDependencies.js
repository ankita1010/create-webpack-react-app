...
var getDevDependencies = function getDevDependencies(_ref) {
  var imageOptiFlag = _ref.imageOptiFlag,
      styleFlag = _ref.styleFlag;
  ...
  var imageDependencies = imageOptiFlag ? ['url-loader'] : [];
  var styleDependencies = styleFlag ? ['node-sass', 'sass-loader'] : [];
  return [].concat(devDependencies, imageDependencies, styleDependencies);
};
